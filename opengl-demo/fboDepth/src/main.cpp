...
// main.cpp
// ========
// testing Frame Buffer Object (FBO) for "Render To Texture" (depth buffer only)
...
const int   DATA_SIZE       = TEXTURE_WIDTH * TEXTURE_HEIGHT * sizeof(float);
...
// function pointers for VBO/PBO extensions
#ifdef _WIN32
